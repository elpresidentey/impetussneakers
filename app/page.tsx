              ...
              <button className="group relative min-h-[250px] overflow-hidden text-left md:col-span-12 opacity-0 animate-[fadeIn_0.6s_ease-out_0.55s_forwards]" onClick={() => document.getElementById('shop')?.scrollIntoView({ behavior: 'smooth' })}>
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
                  <div className="max-w-4xl mx-auto w-full text-center md:text-left">
                    <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.3em] text-white/70">04 / Drop room</p>
                    ...
                    <h3 className="mt-2 text-2xl font-black uppercase leading-[0.9] transition-colors duration-300 group-hover:text-white md:text-3xl text-white">Fresh drops weekly.</h3>
                  </div>
                  <div className="mt-8 flex justify-center md:justify-start">
                    <span className="inline-flex items-center gap-2 border-b border-white/50 pb-0.5 text-xs font-semibold uppercase tracking-[0.16em] text-white transition-all duration-300 group-hover:border-white group-hover:text-white">
                      See drops
